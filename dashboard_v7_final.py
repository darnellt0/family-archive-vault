...
def pending_review():
    ...
    paginated = paginate_items(items, page)
    return render_template('gallery.html', title="Pending Review", items=paginated['items'], status_filter="pending", search_query=search_query, sort_by=sort_by, pagination=paginated, search_mode=search_mode)
...
def approved_items():
    ...
    paginated = paginate_items(items, page)
    return render_template('gallery.html', title="Approved Archive", items=paginated['items'], status_filter="approved", search_query=search_query, sort_by=sort_by, pagination=paginated, search_mode=search_mode)
